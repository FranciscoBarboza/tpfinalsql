...
class Pasajero{
    ...
    public function buscar($rdocumento){
        $base= new BaseDatos();
        $consultaPersona= 'select * from  Persona where rdocumento= ' . $rdocumento;
        $resp= false;
        if ($base->Iniciar()) {
    ...
    public function insertar(){
        $base= new BaseDatos();
        $resp= false;
        $consultaInsertar="INSERT INTO Persona(rdocumento, pnombre, papellido, ptelefono, idviaje)
...
$idviaje;  */
    ...
    public function modificar(){
        $resp= false;
        $base= new BaseDatos();
        $consultaModifica= "UPDATE Persona SET pnombre=" . $this->getPnombre() . ",papellido=". $this->getPapellido() . ",ptelefono=". $this->getPtelefono() . ",idviaje=" . $this->getIdviaje().
    ...
    public function eliminar(){
        ...
        if ($base->Iniciar()) {
            $consultaBorra= "DELETE FROM Persona WHERE rdocumento=" . $this->getRdocumento();
